# Capability: Common Configuration

## Purpose
The configuration system manages application settings across different domains (LLM, RAG, Atlassian, General), providing a unified way to persist and load user-defined parameters for the KB Agent.
