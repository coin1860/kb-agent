---
title: Interactive RAG Sources
domain: synthesis
---

# rag-interactive-sources Specification

## Purpose
Defines requirements for rendering source citations interactively in the TUI to improve usability and isolate context.
